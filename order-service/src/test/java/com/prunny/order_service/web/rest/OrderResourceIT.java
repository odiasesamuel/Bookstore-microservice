...
import static com.prunny.order_service.web.rest.TestUtil.createUpdateProxyForBean;
import static com.prunny.order_service.web.rest.TestUtil.sameNumber;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().userId(DEFAULT_USER_ID).bookIsbn(DEFAULT_BOOK_ISBN).quantity(DEFAULT_QUANTITY).totalAmount(DEFAULT_TOTAL_AMOUNT);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().userId(UPDATED_USER_ID).bookIsbn(UPDATED_BOOK_ISBN).quantity(UPDATED_QUANTITY).totalAmount(UPDATED_TOTAL_AMOUNT);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.userId(UPDATED_USER_ID).bookIsbn(UPDATED_BOOK_ISBN).quantity(UPDATED_QUANTITY).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantity(UPDATED_QUANTITY).totalAmount(UPDATED_TOTAL_AMOUNT);
